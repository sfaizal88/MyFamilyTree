    	...
    	<SafeAreaView style={styles.safeViewContainer}>
	        ...
	        <ScrollView style={[styles.body, styles.p0]}>
	        	<View style={[styles.contentBody, styles.mt0]}>
	                ...
	                <Text style={styles.contentBodyText}>{'\t'}Your privacy is important to us. It is OnMoney's policy to respect your privacy regarding any information we may collect from you across our website, http://onmoney.iwaymen.com, and other sites we own and operate.</Text>
